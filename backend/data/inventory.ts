...
const inventory: Partial<IItem>[] = [
  {
    ...
    category: "Tents",
    description:
      "Inspired by the traditional practicalities of a Classic Bell Tent & revolutionised with modernised features to effectively increase the thrills of your next outdoor adventure.",
  },

  {
    ...
    category: "Tents",
    description:
      "The Hi Gear Emperor Tent is a huge premium polycotton bell tent designed to be the ultimate home from home for glamping getaways and camping trips with family and friends.",
  },
...

  {
    ...
    category: "Tents",
    description:
      "The Air 800 Nightfall Tent is the latest version of this iconic Berghaus tent and replaces the Air 8.1 that came before with an enhanced construction and a stylish new look to hold 8 people.",
  },

  {
    ...
    category: "Tents",
    description:
      "The Berghaus Air 600 Nightfall® is a luxury six-person tent made from premium fabrics and features a convenient air inflation system that makes set-up quick and easy. The impressively sized family tent boasts an improved angled beam structure that delivers more useable living space for furniture, storage or room to stretch out.",
  },

  {
    ...
    category: "Tents",
    description:
      "With a semi-geodesic construction and tension straps, the Berghaus Cheviot 2 is a sturdy tent, making it ideal in adverse weather conditions. An all season lightweight waterproof tent which comfortably sleeps two; ideal for a festival or night away.",
  },
...

  {
    ...
    category: "Sleep",
    description:
      "The Zempire Monstabed queen is a premium camping mattress that combines the comfort of our Monstamat camping mat with the support of a durable inflatable airbed base. Designed as a spacious camp bed for two, it delivers home-like comfort without the need for a stretcher.",
  },
...

  {
    ...
    category: "Sleep",
    description:
      "Our Summit 250 Sleeping Bag is a 3 season bag, perfect for outdoor use in chilly weather. With increased insulation thanks to the mummy shape, you'll be kept comfy and snug as you sleep.",
  },

  {
    ...
    category: "Sleep",
    description:
      "Well-insulated down sleeping bag with well thought through functions for winter trips in extreme cold. Padded with our highest-quality down, with excellent insulation and compressibility. The down is in box channels, reducing the risk of cold spots. The characteristic hood is inspired by our warmest jackets and has detachable synthetic fur edging that minimises heat loss.",
  },

  {
    ...
    category: "Sleep",
    description:
      "Our high-performance sleeping bag fits perfectly inside all TentBox models and has an ‘extreme’ temperature rating of -11°C. Fully unzip it to turn it into a large blanket, or connect two of them together to create a double sleeping bag. The 100% cotton liner means it’s super soft and the nylon outer shell is both hardwearing and easy to clean. It comes with a stuff sack for easy storage. *If you purchase two, you can connect them together to make a double sleeping bag!* ",
  },

  {
    ...
    category: "Sleep",
    description:
      "The Adults 3 Season Sleeping Bag Lull is designed for outdoor enthusiasts seeking comfort during camping, hiking, or backpacking trips. Crafted from durable 100% polyester, both the shell and lining ensure warmth and resilience. This sleeping bag features an efficient filling for optimal insulation, making it suitable for a range of weather conditions.",
  },
...

  {
    ...
    image: [
      ...
      "/images/Merapi-Pro-Duo-Deluxe-3.webp",
      "/images/Merapi-Pro-Duo-Deluxe-4.webp",
      "/images/Merapi-Pro-Duo-Deluxe-5.webp",
      "/images/Merapi-Pro-Duo-Deluxe-6.webp",
    ],
    category: "Cooking",
    description:
...

  {
    ...
    category: "Cooking",
    description:
      "The Frontier UL One Pot Cook Set features the Pouring Pot, two medium bowls and two cups. The 2.2L Pouring Pot is made from hard-anodised alloy for durability and versatility. The abrasion resistant ceramic coating and a removable handle our Frontier UL Pots make mealtimes easy and efficient.",
  },
...

  {
    ...
    description:
      "Whether it's a weekend camping trip or a festival, the Decathlon Folding Transport Trolley keeps your gear moving. The foldable frame packs down for easy storage in your car boot or garage when you're not heading out. Large wheels roll smoothly over grass, gravel and uneven ground, so you can haul tents, sleeping bags, and supplies from car to pitch without multiple trips.",
  },
